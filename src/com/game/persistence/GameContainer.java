...
/**
 * The GameContainer holds, manages, and runs the various components that make up the game.
 * @author Dennis Jr
 *
 */
public class GameContainer implements IGameContainer{
	...
	/** 
	 * Determines whether to continue running the game loop. While true, the game loop 
	 * continues to execute. When false, the game loop ends. 
	 */
	private boolean running;
	
	/**
	 * Creates a new GameContainer with null input, graphics, and state, and is currently
	 * running. Use the appropriate setter methods to set input, graphics, and state after
	 * creation.
	 */
	...
	/**
	 * Sets the currently running game state. The new state will take effect on the next 
	...
	/**
	 * The game loop, which consists of updating game logic and then rendering the updated 
	 * game environment to the screen. This cycle continues until something specifies that 
	 * it should stop, such as a request to exit the application.
	 */
	 ...
	 * @param input the input listeners to be set.
	 */
	 ...
	 * @param graphics the rendering mechanisms to be set.
	 */
