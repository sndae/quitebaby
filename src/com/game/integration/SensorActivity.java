...
/**
 * This class functions as an event listener for the accelerometer on the device.
 * This class does not handle the events for the sensor only allows access to them. 
 * @author Kenny
 */
